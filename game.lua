...
local appID = "566d2cbc5db763270200000b"
...
function scene:createScene(event)
 ...
 --down tiles till here
    ...
    statue.y = display.contentHeight - 300
	statue:play()
    ...
    bird.y = display.contentHeight - 300
...
function rtTouch(event)
 ...
 -- print("aaaa")
bird:applyForce(150, -800, bird.x, bird.y)
