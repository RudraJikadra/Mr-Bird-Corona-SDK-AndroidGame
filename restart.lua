...
--local banner = RevMob.createBanner({x = display.contentWidth / 2, y = display.contentHeight - 50, width = display.contentWidth, height = 100 })
 ...
 local banner = RevMob.createBanner({x = display.contentWidth / 2, y = display.contentHeight - display.contentHeight*0.04, width = display.contentWidth, height = display.contentHeight*0.08 })
...
local REVMOB_IDS = {
 [REVMOB_ID_IOS] = '55cf71cd4f79baa315a3a5b5',
 [REVMOB_ID_ANDROID] = '55cf71cd4f79baa315a3a5b5',
 
}

if AMAZON_APK then REVMOB_IDS[REVMOB_ID_ANDROID] = '55cf71cd4f79baa315a3a5b5' end
